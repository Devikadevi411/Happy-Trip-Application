...
public class ProfileApiTest {
	...
	@Test
	@DisplayName("Test Profiledetails by emailId - GET /api/v1/reg/")
	public void testGetProfiledetailsByemailId() throws Exception {
		
		// Prepare Mock Profiledetails
		Profile Profiledetails = new Profile("gowthamikummara99@gmail.com","GowthamiKummara","Female","02-05-1999","Chittoor","Palamaner","AndhraPradesh","517408","India","6309648757");
		Profiledetails.setEmailId("devikadevi2704@gmail.com");
		
		// Prepare Mock Service Method
		
		doReturn(Optional.of(Profiledetails)).when(repository).findByEmailId(Profiledetails.getEmailId());
	...
	public void testAddNewProfiledetails() throws Exception {
		...
		// Prepare Mock Profiledetails
		Profile newProfiledetails= new Profile ("gowthamikummara99@gmail.com","GowthamiKummara","Female","02-05-1999","Chittoor","Palamaner","AndhraPradesh","517408","India","6309648757");
		
		Profile  mockProfiledetails = new Profile ("gowthamikummara99@gmail.com","GowthamiKummara","Female","02-05-1999","Chittoor","Palamaner","AndhraPradesh","517408","India","6309648757");
	...
	public void testUpdateExistingProfiledetails() throws Exception {
		...
		Profile mockProfiledetails = new Profile("ujjainee@gmail.com","Ujjainee","Female","06-05-1999","Kolkata","Howrah","WestBengol","517409","India","1234567898");
		
		Profile ProfiledetailsToBeUpdated = new Profile("ujjainee@gmail.com","Ujjainee","Female","06-05-1999","Kolkata","Howrah","WestBengol","517409","India","1234567898");
		ProfiledetailsToBeUpdated.setEmailId("ujjainee@gmail.com");
		
		
		mockProfiledetails.setEmailId("ujjainee@gmail.com");
		// Prepare Mock Service Method
		
		doReturn(Optional.of(mockProfiledetails)).when(repository).findById("ujjainee@gmail.com");
		
		doReturn(mockProfiledetails).when(repository).save(ArgumentMatchers.any());
		
		// Perform GET Request
		
		mockMvc.perform(put("/api/v1/Profiledetailss/{emailId}","ujjainee@gmail.com")
		// Validate Status should be 200 OK and JSON response received
		...
		.andExpect(status().isCreated())
		.andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
		.andExpect(jsonPath("$.emailId", is("Ujjainee@gmail.com")))
		.andExpect(jsonPath("$.fullName", is("Ujjainee")))
		.andExpect(jsonPath("$.gender", is("female")))
		.andExpect(jsonPath("$.dateOfBirth", is("06-05-1999")))
		.andExpect(jsonPath("$.City", is("Kolkata")))
		.andExpect(jsonPath("$.Address", is("Howrah")))
		.andExpect(jsonPath("$.State", is("WestBengol")))
		.andExpect(jsonPath("$.Pincode", is("517409")))
		.andExpect(jsonPath("$.Country", is("India")))
		.andExpect(jsonPath("$.PhoneNumber", is("1234567898")));
